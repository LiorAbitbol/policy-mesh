...
| 5 | T-102 | Implement DecisionEngine with reason codes | `todo` | `planner` | `context/private/tasks/T-102.md` |
| 6 | T-103 | Implement Ollama and OpenAI provider clients | `todo` | `planner` | `context/private/tasks/T-103.md` |
| 7 | T-105 | Add `/v1/chat` orchestration service | `todo` | `planner` | `context/private/tasks/T-105.md` |
| 8 | T-106 | Add metrics middleware + `/v1/metrics` | `todo` | `planner` | `context/private/tasks/T-106.md` |
| 9 | T-107 | Add integration tests with mocked providers | `todo` | `planner` | `context/private/tasks/T-107.md` |
