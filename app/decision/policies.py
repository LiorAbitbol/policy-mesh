...
def cost_prefer_local(
    ...
    - cost_usd ~= (tokens / 1_000_000) * llm_input_usd_per_1m_tokens
    ...
    if (
        ...
        and llm_input_usd_per_1m_tokens is not None
    ):
        ...
        if tokens_estimate < 0:
            tokens_estimate = 0.0
        cost_usd = (tokens_estimate / 1_000_000) * llm_input_usd_per_1m_tokens
